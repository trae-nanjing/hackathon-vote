        ...
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full mx-4">
          <div className="text-center">
            ...
            <div className="space-y-3">
              ...
              <Link
                to="/"
                className="block w-full bg-gray-100 hover:bg-gray-200 text-gray-700 px-6 py-2 rounded-lg transition-colors text-center"
              >
                返回投票页面
              </Link>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-8">
              <div className="flex items-center justify-center space-x-3 mb-4">
                ...
                <h1 className="text-3xl font-bold text-gray-900">实时投票结果</h1>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white rounded-xl shadow-lg p-6 text-center">
                ...
                <p className="text-gray-600">参赛队伍</p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 text-center">
                ...
                <p className="text-gray-600">当前领先</p>
              </div>
            </div>
                  ...
                  {voteRecords.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {voteRecords.slice(0, 3).map((record, index) => {
                        ...
                        return (
                          <div key={record.team_id} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                            {getRankIcon()}
                            <div className="flex-1 min-w-0">
                              <p className="font-medium text-gray-900 truncate">
                                {record.teams?.name || `队伍 ${record.team_id}`}
                              </p>
                              <p className="text-sm text-gray-500">{record.vote_count} 票</p>
                            </div>
